...
% ----------------------------------------------------------------------
    ...
    \href{https://juseg.github.io/outreach/}{glacier animations}, I hope to get
    my work further noticed and understood outside academia (e.g., museum
...
\guideline{
    ...
    Earlier this year (29 Aug. - 2 Sep. 2022) we invited three glacial
    geologists (Anna Hughes from University of Manchester, UK; Martin Margold
    and Helen Dulfer from Charles University, Czech Republic) in Bergen to
    kick-off this network and discuss challenges ahead.
    ...
    but similar vision on software communication and outreach. This was my
    motivation to participate in the recent
