...
% ----------------------------------------------------------------------
    ...
    More importantly, with this project we pave the way to a more open and more
    efficient methods and data communication culture in paleoglaciology and the
    rest of academia.
...
% ----------------------------------------------------------------------
    ...
    position at the university of Bergen as a way to ``qualify [...] to senior
    academic positions'' (I also hope national regulations are false, as the
    number of trainees far outweight the number of academic positions and one
    could argue this, that is we, are a vast waste of human resources and
    public funds). Instead, I see my temporary position as an opportunity to
    ...
    only results, but also and the research process, need to be more openly
    commicated both within and beyond academia. Thus as a researcher, I am
    dedicated to publishing research methods, software, data, and of course
